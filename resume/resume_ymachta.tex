...
\begin{document}
	...
	\resumeItemListStart
	\resumeItem{Built a real-time gesture retrieval engine for an embodied conversational agent, combining rule-based heuristics with embedding similarity.}
	% \resumeItem{Moving towards learned, context-sensitive gesture generation.}
	\resumeItemListEnd
...
\section{Skills}
\begin{itemize}[leftmargin=*]
	\item \textbf{Programming Languages:} Python (PyTorch, Scikit-learn/image, Selenium, pandas, Numpy, matplotlib), Docker, Kubernetes, ArgoCD, Slurm, Git, GitHub Actions (basic), CI/CD (basic). learning CUDA/C++ and Godot.
\end{itemize}
...
\begin{itemize}[leftmargin=*]
    \resumeItem{\textbf{Machta, Y.}, Le Chapellier, M., Silem, O., Cassel, J (2025). "Semantic Gesture Retrieval for real-time co-speech gestures" In \textit{ACM Multimedia GENEA Workshop}, 2025. (\href{https://MachtaYassine.github.io/Papers/GENEA2025-PosterDraft-YMACHTA-ARTICULAB.pdf}{\underline{Poster}})}
